                ...
                <div class="bg-white rounded-[18px] border border-black/10 p-8 shadow-[0_10px_30px_rgba(0,0,0,0.08)]">
                    ...
                    <form method="POST" action="{{ route('admin.login.post') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="password" id="admin-password" name="password" placeholder="Enter your password" class="w-full h-12 px-4 pr-12 rounded-lg border border-black/10 bg-white text-[#0f1115] text-[14px] focus:outline-none focus:ring-2 focus:ring-black/20" required />
                                <button type="button" onclick="togglePassword('admin-password', this)" class="absolute right-3 top-1/2 -translate-y-1/2 text-black/40 hover:text-black/60 transition">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <a href="{{ route('admin.forgot-password') }}" class="text-[13px] font-[700] text-black/60 hover:text-black transition">Forgot password?</a>
                        </div>
