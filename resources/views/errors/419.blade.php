...
<head>
    ...
    <title>419 - Page Expired | TESLA</title>
...
<body>
    <div class="text-center px-4" style="max-width: 600px; width: 100%;">
        ...
        <div style="display: flex; gap: 12px; justify-content: center; flex-wrap: wrap;">
            <button onclick="window.location.reload()" style="padding: 12px 24px; background: #111827; color: white; border-radius: 10px; font-size: 14px; font-weight: 900; cursor: pointer; border: none; display: inline-flex; align-items: center; gap: 8px;">
