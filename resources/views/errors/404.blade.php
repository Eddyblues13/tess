...
<head>
    ...
    <title>404 - Page Not Found | TESLA</title>
...
<body>
    <div class="text-center px-4" style="max-width: 600px; width: 100%;">
        ...
        <div style="display: flex; gap: 12px; justify-content: center; flex-wrap: wrap;">
            ...
            <button onclick="window.history.back()" style="padding: 12px 24px; background: rgba(255, 255, 255, 0.1); color: white; border-radius: 10px; font-size: 14px; font-weight: 900; cursor: pointer; border: 1px solid rgba(255, 255, 255, 0.2); display: inline-flex; align-items: center; gap: 8px;">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
